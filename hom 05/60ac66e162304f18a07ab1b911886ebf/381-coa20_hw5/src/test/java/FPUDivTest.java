...
public class FPUDivTest {
    ...
    @Test
    public void fpuDivTest12(){
        String dividend = "00111110111000000000000000000000";
        String divisor  = "00111111001000000000000000000000";
        String expected = "00111111001100110011001100110011";
        String result = fpu.div(dividend,divisor);
        assertEquals(expected, result);
    }
}
