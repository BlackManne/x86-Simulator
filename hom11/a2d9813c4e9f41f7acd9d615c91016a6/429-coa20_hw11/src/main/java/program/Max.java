...
public class Max {
	...
	public int max(int a, int b) {
		...
		//a和b的二进制表示
		String ainbinary = t.intToBinary(String.valueOf(a));
		String binbinary = t.intToBinary(String.valueOf(b));
		//将a,b写入对应的寄存器
		CPU_State.eax.write(ainbinary);
		CPU_State.ecx.write(binbinary);
		String instrA = "110001111000001100000000000000000000000000000000" + ainbinary;
		String instrB = "110001111000001100000000000000000000000000100000" + binbinary;
